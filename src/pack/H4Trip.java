...
public class H4Trip
{
	...
	public static void insert()
	{
		...
		int i=s.executeUpdate("INSERT INTO 4HOTELS VALUES('"+loc+"','"+name+"','"+star+"',"+rooms+",'"+add+"',"+phone+","+price+")");
		if(i!=0)
...
public static void updatePrice()
	{
		...
		{
			s=con.createStatement();
			rs=s.executeQuery("select * from 4HOTELS");
			int i=s.executeUpdate("UPDATE 4HOTELS SET PRICE="+p+" where ADDRESS ='"+add+"'");
			if(i>0)
...
public static void delete()
	{
		...
		try
		{
			s=con.createStatement();
			rs=s.executeQuery("select * from 4HOTELS");
			int i=s.executeUpdate("delete from 4HOTELS where ADDRESS='"+add+"'");
			if(i>0)
