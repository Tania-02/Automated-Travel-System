...
<b>YOUR FLIGHT OF 
<%int p=Integer.parseInt((String)session.getAttribute("seats1"));
     out.print(p);%>
 SEAT(S) HAS BEEN BOOKED SUCESSFULLY!!!!<b>
 <br><br><br><br>
<b>DETAILS:-<b>
<br><br>
<table border="1" cellspacing="4" cellpadding="4">
	<tr><th>Flight_Id</th><th>DATE</th><th>ORIGIN</th><th>DESTINATION</th><th>PRICE</th>
	<tr><td><%//int i=Integer.parseInt(session.getAttribute("id1").toString());
	int i=Integer.parseInt(request.getParameter("id1"));
	out.print(i);%></td><td><%String l=(String)session.getAttribute("date1");
     out.print(l);%></td><td><%String j=(String)session.getAttribute("origin1");
     out.print(j);%></td><td><%String k=(String)session.getAttribute("dest1");
     out.print(k);%></td><td><%double m=Double.parseDouble(session.getAttribute("price1").toString());
     out.print(m);%></td>

	<td><a href='Payment.html'>CONFIRM</a></td></tr>
	 </table> 
<footer>
		<section>
