<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="java.util.*,pack.*"%><!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<title>bus</title>
...
<header>
		...
		<nav>
			...
			<ul>
				...
				<li><a href="bus.html" class="current">BUS</a></li>
...
<% id=Integer.parseInt(request.getParameter("id"));
	int seat=(int)session.getAttribute("seatbus");
 ...
 for(Bus s:list)
 {
	   ...
	   {	
 			...
 			<table border='1' cellpadding ='4' width='60%'>
  			<tr><th>ORIGIN</th><th>DESTINATION</th><th>TYPE</th><th>RATE</th><th>SEATS</th><th>DATE</th><th>ID</th><th>Seats_Booked</th>
   			<tr><td><%=s.getOrigin()%></td><td><%=s.getDestination()%></td><td><%=s.getType()%></td><td><%=s.getRate()%></td><td><%=seat%></td>
	  		<td><%=s.getDept() %><td><%=s.getID()%><td><a href='Payment.jsp?book=<%= "bus" %>'>Confirm</a></td></tr>
	  		<%
	  		session.setAttribute("busseat",s.getSeats()-seat);
	  		//BusDAO.setSeat(id,s.getSeats()-seat);
	  		break;
		}
 }
	%>
